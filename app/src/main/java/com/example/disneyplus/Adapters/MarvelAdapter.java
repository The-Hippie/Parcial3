package com.example.disneyplus.Adapters;
...
import com.example.disneyplus.ui.detalles.DetalleFragment;
...
public class MarvelAdapter extends RecyclerView.Adapter<MarvelAdapter.viewHolder> implements Filterable {
    ...
    public MarvelAdapter(FragmentActivity activity, List<Marvel> marvelList) {
    }

    @NonNull
    @Override
    public viewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new viewHolder(LayoutInflater.from(context).inflate(R.layout.sample_marvel, parent, false));
    }
    ...
    public void onBindViewHolder(@NonNull viewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, DetalleFragment.class);
